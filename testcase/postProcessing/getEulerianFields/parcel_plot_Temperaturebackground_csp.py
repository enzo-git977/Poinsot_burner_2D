...
for i in range(len(x_positions)):
    ...
    vtk_file_t = os.path.join(POSTPROCESSING_DIR, "cuttingPlanes", time_str_folder, "zMid.vtk")
    ...
    # Save the image
    #plt.tight_layout()
    fig.savefig(f"pictures_csp_with_T/parcel_{i:04d}.png", dpi=150)
    plt.close(fig)
    print(f"Plotting successful for t={time_stamps[i]:.4f}")

print("Pictures.png saves in GetEulerianFields/pictures_csp_with_T")
