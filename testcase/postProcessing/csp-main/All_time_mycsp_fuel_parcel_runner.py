...
for time_dir in time_dirs:
    ...
    input_file = os.path.join(folder_path, "fuelCloud.dat")
    output_file = os.path.join(folder_path, "fuelCloud_withCSP.dat")

    if not os.path.isfile(input_file):
        print(f"?? No fuelCloud.dat in {time_dir}, skipping...")
        continue
